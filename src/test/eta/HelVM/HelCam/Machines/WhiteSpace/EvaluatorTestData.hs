...
primIL = 
  [Mark "prints",Dup,Branch EZ "prints_end",OutputChar,Jump "prints"
  ,Mark "prints_end",Liter 0,Return
  ,Mark "printsln",Call "prints",Liter 21,Liter 0
  ]
