...
runVector ∷ (AppSafeEff m , Symbol e) ⇒ TreeInstructionVector → FullTape e → m $ Memory e
...
doInstruction ∷ (AppSafeEff m , Symbol e) ⇒ Maybe TreeInstruction → InstructionMemory → FullTape e → m $ Memory e
...
doWhile ∷ (AppSafeEff m , Symbol e) ⇒ TreeInstructionVector → InstructionMemory → FullTape e → m $ Memory e
