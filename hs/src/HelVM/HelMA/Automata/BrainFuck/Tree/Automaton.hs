module HelVM.HelMA.Automata.BrainFuck.Tree.Automaton (
  runSource,
) where

import           HelVM.HelMA.Automata.BrainFuck.Tree.Instruction
import           HelVM.HelMA.Automata.BrainFuck.Tree.Parser
