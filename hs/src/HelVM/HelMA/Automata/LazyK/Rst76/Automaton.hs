module HelVM.HelMA.Automata.LazyK.Rst76.Automaton (
  runWithParams,
  run,
  runReduce,
) where

import           HelVM.HelMA.Automata.LazyK.Rst76.InputEncoder

import           HelVM.HelMA.Automata.LazyK.Parsers.CombinatorParser
